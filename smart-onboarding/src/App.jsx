          ...
          <div className="card hero">
            ...
            <AccordionItem id="personal" openId={openId} setOpenId={setOpenId} title={t("personal_title")}>
              <div id="personal-section">
                <PersonalSection t={t} personal={personal} setPersonal={setPersonal} />
              </div>
            </AccordionItem>


            <AccordionItem id="car" openId={openId} setOpenId={setOpenId} title={t("car_title")}>
              <CarSection t={t} car={car} setCar={setCar} onValid={onCarValid} />
              <div className="actions"><button className="btn ghost" onClick={()=>setOpenId('personal')}>{t("back")}</button></div>
            </AccordionItem>
